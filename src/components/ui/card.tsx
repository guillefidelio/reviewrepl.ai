  ...
  "bg-card text-card-foreground flex flex-col gap-6 rounded-xl border py-6 shadow-sm",
  {
    variants: {
      variant: {
        ...
        elevated: "bg-card text-card-foreground border-border shadow-md hover:shadow-lg transition-shadow duration-200",
        ...
        filled: "bg-muted/50 text-card-foreground border-transparent shadow-none",
      },
    },
    defaultVariants: {
      variant: "default",
